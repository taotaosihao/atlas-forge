...
run_success_case() {
  ...
  for command_name in atlas-native-agent-inbox atlas-plugin-integrity atlas-team-model-catalog atlas-workflow atlas-zenmux-bearer-token codex-design-review codex-refresh-local-plugin codex-workflow; do
