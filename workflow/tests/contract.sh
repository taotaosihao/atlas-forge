...
rg -q 'atlas-sdd-implementer.*gpt-5\.6-sol.*medium.*none' "$source_skills_root/team/SKILL.md"
rg -q 'atlas-sdd-reviewer.*gpt-5\.6-sol.*max.*none' "$source_skills_root/team/SKILL.md"
rg -q 'atlas-sdd-planner.*gpt-5\.6-sol.*max.*none' "$source_skills_root/team/SKILL.md"
rg -q 'atlas-sdd-phase-reviewer.*gpt-5\.6-sol.*medium.*none' "$source_skills_root/team/SKILL.md"
rg -q 'Explicit Saving Mode' "$source_skills_root/team/SKILL.md"
