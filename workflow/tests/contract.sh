...
rg -q "default ordinary lanes to Codex native collaboration" "$source_skills_root/team/SKILL.md"
rg -q "DeepSeek Flash implementation and exploration alternatives.*Paseo" "$source_skills_root/team/SKILL.md"
rg -q "For any other Paseo use, require an explicit user or operator choice" "$source_skills_root/team/SKILL.md"
...
rg -q "read .*orchestration-preferences.json" "$source_skills_root/team/SKILL.md"
...
rg -q -- '--provider deepseek --model deepseek-v4-flash:deepseek --thinking max' "$source_skills_root/team/SKILL.md"
rg -q 'atlas-sdd-reviewer.*gpt-5\.6-terra.*high.*none' "$source_skills_root/team/SKILL.md"
rg -q 'atlas-sdd-planner.*gpt-5\.6-sol.*medium.*none' "$source_skills_root/team/SKILL.md"
rg -q 'atlas-sdd-phase-reviewer.*gpt-5\.6-sol.*medium.*none' "$source_skills_root/team/SKILL.md"
! rg -q '\| Routine implementation \(ZenMux alternative\)|\| Read-heavy exploration \(ZenMux alternative\)' "$source_skills_root/team/SKILL.md"
