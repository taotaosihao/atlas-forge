...
rg -q "Critical feedback and stop conditions" "$source_skills_root/clarify/SKILL.md"
...
rg -q "Select one canonical scope source" "$source_skills_root/clarify/SKILL.md"
...
rg -q "only when explicit handoff, audit, release, or existing project-document authority requires it" "$source_skills_root/clarify/SKILL.md"
