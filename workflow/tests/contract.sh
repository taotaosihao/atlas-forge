...
rg -q 'Saving/model/lease/release choices are independent' "$ATLAS_FORGE_ROOT/plugins/atlas-workflow/.codex-plugin/plugin.json"
rg -q 'Certified is source-ready, not released' "$ATLAS_FORGE_ROOT/plugins/atlas-workflow/.codex-plugin/plugin.json"
...
rg -q "prefer parallel native agents" "$source_skills_root/team/SKILL.md"
