...
rg -q "Inside Team, default to Codex native collaboration" "$source_skills_root/team/SKILL.md"
...
! rg -q "orchestration-preferences\.json|matching role preference" "$source_skills_root/team/SKILL.md"
...
rg -q 'atlas-sdd-implementer-deepseek.*deepseek-v4-flash:deepseek.*high.*none' "$source_skills_root/team/SKILL.md"
...
rg -q 'atlas-sdd-explorer-deepseek.*deepseek-v4-flash:deepseek.*high.*none' "$source_skills_root/team/SKILL.md"
