...
rg -q 'atlas-sdd-implementer.*gpt-5\.6-sol.*max.*none' "$source_skills_root/team/SKILL.md"
rg -q 'atlas-sdd-reviewer.*gpt-5\.6-sol.*high.*none' "$source_skills_root/team/SKILL.md"
