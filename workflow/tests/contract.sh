...
rg -Uq "ask once for confirmation of the resulting shared\s+understanding" "$source_skills_root/intake/SKILL.md"
rg -Uq "grilling introduced a new decision or an unresolved gap\s+remains" "$source_skills_root/intake/SKILL.md"
rg -Uq "no new decision or gap, do not ask for an extra\s+confirmation" "$source_skills_root/intake/SKILL.md"
rg -Uq "(?s)grilling request and these confirmations do not grant\s+implementation authority" "$source_skills_root/intake/SKILL.md"
