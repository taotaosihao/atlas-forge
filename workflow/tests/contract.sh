...
rg -q 'named external candidates remain product_release' "$ATLAS_FORGE_ROOT/plugins/atlas-workflow/.codex-plugin/plugin.json"
rg -q 'completion-derived release_decision.status=certified supports a source-level release-ready claim' "$ATLAS_FORGE_ROOT/plugins/atlas-workflow/.codex-plugin/plugin.json"
rg -q 'never authorizes install, push, deploy, publication, or actual release' "$ATLAS_FORGE_ROOT/plugins/atlas-workflow/.codex-plugin/plugin.json"
