...
rg -q "default to Codex native collaboration.*DeepSeek Flash" "$source_skills_root/team/SKILL.md"
...
rg -q 'atlas-sdd-implementer-deepseek.*deepseek-v4-flash:deepseek.*max.*none' "$source_skills_root/team/SKILL.md"
...
rg -q 'atlas-sdd-explorer-deepseek.*deepseek-v4-flash:deepseek.*max.*none' "$source_skills_root/team/SKILL.md"
