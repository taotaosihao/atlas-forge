...
rg -q "First Code Slice Guard" "$source_skills_root/team/SKILL.md"
rg -q "First-code guard" "$source_skills_root/clarify/SKILL.md"
rg -q "First-code guard" "$source_skills_root/task/SKILL.md"
...
rg -q "Operable UI Vertical Slice Gate" "$source_skills_root/team/SKILL.md"
rg -q "served operable UI thin slice" "$source_skills_root/team/SKILL.md"
rg -q "hard safety gates must be satisfied together" "$source_skills_root/team/SKILL.md"
rg -q "Product/UI gate" "$source_skills_root/clarify/SKILL.md"
rg -q "Product/UI gate" "$source_skills_root/task/SKILL.md"
...
rg -q "page.setContent" "$ATLAS_FORGE_ROOT/workflow/templates/implementation-contract.md" "$source_skills_root/team/SKILL.md"
rg -q "synthetic HTML" "$ATLAS_FORGE_ROOT/workflow/templates/implementation-contract.final.md" "$source_skills_root/task/SKILL.md"
...
rg -q "no-data-plane-direct" "$source_skills_root/team/SKILL.md"
rg -q "no-cloud-runtime" "$source_skills_root/team/SKILL.md"
rg -q "Goal A: protocol/device integration closure" "$source_skills_root/team/SKILL.md"
rg -q "Goal B: business UI acceptance closure" "$source_skills_root/team/SKILL.md"
