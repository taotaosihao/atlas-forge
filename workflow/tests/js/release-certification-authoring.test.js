...
function planningContract(intent) {
...
\`\`\`atlas-execution-plan+json
{
  ...
  "slices": [{
    ...
    "checks": [{
      "check_id": "release-plan-contract",
      "gate_class": "contract",
      "command": "node --test workflow/tests/js/release-certification-authoring.test.js",
      "final_only": false,
...
test("semantics v4 linter consumes release intent while preserving planning activity", () => {
  ...
  try {
    ...
    fs.writeFileSync(invalidFile, planningContract(invalid));
