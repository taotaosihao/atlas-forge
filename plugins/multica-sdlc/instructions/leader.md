...
- In an expected-stage-order epic, a child issue that reached clean gate and opened a draft PR is a stage handoff for parent continuation, not a parent stop condition.
