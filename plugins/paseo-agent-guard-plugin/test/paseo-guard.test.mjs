...
test("plugin manifest and skill frontmatter are valid", () => {
  ...
  const marketplacePlugin = marketplace.plugins.find((entry) => entry.name === "paseo-agent-guard-plugin");
  assert.ok(marketplacePlugin);
  assert.equal(marketplacePlugin.source.path, "./plugins/paseo-agent-guard-plugin");
