# Negation prefix cannot hide positive fulfillment
...
- served_ui_validation_action: Do not skip login, then fulfill index.html; without waiting, fulfill the main document; not only log in, but fulfill app.js; page.goto(browser_entrypoint).
