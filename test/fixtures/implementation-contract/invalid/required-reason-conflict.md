# Required gates with not-applicable reasons

contract_semantics_version: 1
work_type: implementation
first_code_guard: required
first_code_not_applicable_reason: The first-code guard is supposedly not applicable.
product_ui_gate: required
product_ui_not_applicable_reason: The UI gate is supposedly not applicable.
...
- served_ui_validation_action: page.goto(browser_entrypoint); save a document.
- ui_data_mode: local fixture
