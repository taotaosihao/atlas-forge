# Natural-language URL only shares the declared prefix
...
- served_ui_validation_action: The browser opens http://127.0.0.1:4173/editor-malicious and validates the page.
