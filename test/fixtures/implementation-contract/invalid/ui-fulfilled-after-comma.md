# Forbidden UI fulfillment after a comma
...
- served_ui_validation_action: route.fulfill backend API response, returning the main document from index.html and app.js as the application bundle; page.goto(browser_entrypoint).
