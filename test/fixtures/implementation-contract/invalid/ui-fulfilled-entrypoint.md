# Declared entrypoint is fulfilled with raw HTML
...
- served_ui_validation_action: For the backend API, page.route(browser_entrypoint, route => route.fulfill({body: '<html>fake</html>'})); page.goto(browser_entrypoint).
