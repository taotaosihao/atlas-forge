# Regression fixtures around existing behavior
...
product_ui_not_applicable_reason: This is a headless scanner task.

## First Code Slice Guard

- first_code_slice: Add regression scanner fixtures for existing behavior.
