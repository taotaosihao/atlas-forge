# Negated backend label cannot justify fulfillment
...
- served_ui_validation_action: route.fulfill a local fixture, never a backend or API response; page.goto(browser_entrypoint).
- ui_data_mode: Local fixture data
