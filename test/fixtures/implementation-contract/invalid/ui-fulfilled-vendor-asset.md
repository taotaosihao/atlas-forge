# Application asset route is fulfilled
...
- served_ui_validation_action: For the backend API, page.route('/assets/vendor.js', route => route.fulfill({body: 'fake'})); page.goto(browser_entrypoint).
