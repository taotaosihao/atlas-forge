...
- served_ui_validation_action: setContent('<main>synthetic HTML</main>'); page?.setContent('<main>fixture</main>'); page['setContent']('<main>fixture</main>'); assert the form is visible.
- ui_data_mode: synthetic fixture
