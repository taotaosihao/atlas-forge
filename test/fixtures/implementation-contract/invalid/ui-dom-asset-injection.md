# Direct DOM and application asset injection
...
- served_ui_validation_action: page.goto(browser_entrypoint); page.evaluate(markup => document.write(markup), html); page.addScriptTag({content: appBundle}); page.addStyleTag({content: appCss}).
