...
- For `implementation`: code delta estimate, worktree requirement, implementation tasks, test plan, acceptance matrix, evidence manifest, docs impact, and draft PR gate.
