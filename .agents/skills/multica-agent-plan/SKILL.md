...
2. 先盘点当前已有 agent 和 skill：
   ...
   - 读取本地可用 instruction/skill 来源：`/home/gewu/.agents/multica-sdlc/instructions/*.md`、`/home/gewu/.agents/multica-sdlc/generated/*.txt`、`/home/gewu/.agents/skills/*/SKILL.md`。
